function _templateObject2() {
  var data = _taggedTemplateLiteral(["<div @on:click=", ">777</div>"]);
...
var hyperx = function hyperx(h, opts) {
  if (!opts) opts = {};
...
function create(modules) {
  ...
  var patch = init(modules || []); // create snabby function
...
var index = create([attributesModule, eventListenersModule, classModule, propsModule, styleModule]);
/*
import $ from '../libs/jquery/jquery.js';
...
var foo = index(_templateObject(), {
  href: '/foo',
  textContent: 'Hello'
}, fn);
var bar = index(_templateObject2(), fn); // Patch to DOM:

index.update(document.body, foo); // Patch updates:
// html.update(foo, bar)